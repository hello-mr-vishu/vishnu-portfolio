...
const UI = {
  en: {
    ...
    h1_b: 'AI & Data ',
    h1_c: 'Solutions',
    sub: 'I am a passionate B.Tech student exploring AI & Data Science. I specialize in building Python backends, machine learning models, and data engineering pipelines.',
    bullets: [
      { icon: <AutoAwesomeIcon />, label: 'AI & Machine Learning' },
      { icon: <RocketLaunchIcon />, label: 'Python Backend' },
      { icon: <SecurityIcon />, label: 'Data Engineering' },
    ],
  ...
  es: {
    ...
    h1_b: 'Soluciones ',
    h1_c: 'de IA y Datos',
    sub: 'Soy un apasionado estudiante de B.Tech explorando IA y Ciencia de Datos. Me especializo en construir backends en Python, modelos de ML y pipelines de datos.',
    bullets: [
      { icon: <AutoAwesomeIcon />, label: 'IA y Machine Learning' },
      { icon: <RocketLaunchIcon />, label: 'Backend en Python' },
      { icon: <SecurityIcon />, label: 'Ingeniería de Datos' },
    ],
    ctaPrimary: 'Contáctame',
    ctaSecondary: 'Ver proyectos',
    subject: 'Oportunidad de trabajo / Consulta',
